// =============================================
// LOKEA - Card Annonce (Appartement ou Voiture)
// =============================================
...
export function ApartmentCard({ apartment, delay = 0 }) {
  ...
  return (
    ...
    >
      ...
      <Link to={`/appartements/${id}`} className="card block group">
        {/* Image */}
        ...
        {/* Contenu */}
        <div className="p-4">
          <h3 className="font-bold text-dark text-lg mb-1 line-clamp-1 group-hover:text-primary-600
                         transition-colors">
            {title}
          </h3>
          ...
          {amenities?.length > 0 && (
            <div className="flex flex-wrap gap-1.5 mb-4">
              {amenities.slice(0, 3).map((a) => (
                <span key={a} className="text-xs bg-primary-50 text-primary-700
...
export function CarCard({ car, delay = 0 }) {
  ...
  return (
    ...
    >
      {/* CORRECTION : Lien vers 'id' */}
      <Link to={`/voitures/${id}`} className="card block group">
        {/* Image */}
        <div className="relative h-48 overflow-hidden bg-gray-100">
          ...
          <div className="absolute top-3 right-3 bg-dark/70 text-white text-xs
        ...
        {/* Contenu */}
        <div className="p-4">
          <h3 className="font-bold text-dark text-lg mb-3 line-clamp-1 group-hover:text-primary-600
                         transition-colors">
            {title}
          </h3>
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            ...
            <div className="bg-gray-50 rounded-xl p-2 text-center">
              ...
              <span className="text-xs text-gray-600">{seats} places</span>
            </div>
          </div>
